          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg"><Link href="/contact">Get Your Free UK Media Audit Consultation</Link></Button>
                <Button size="lg" variant="ghost"><Link href="/case-studies">View UK Client Success Stories</Link></Button>
              </div>
            </div>
          </div>
        </div>
